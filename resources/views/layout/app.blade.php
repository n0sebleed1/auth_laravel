...
<body>
    ...
    <header>
        ...
        <div class="header__user-data">
            <img style="border-radius: 16px;" src="{{ asset('storage/app/public/' . $profileInfo->avatar) }}" width="32" height="32">
            <form method="POST" action="{{ route('logout') }}" class="header__user-data-right">
                @csrf
                <p class="header__user-data-name">{{ $name }}</p>
            ...
            <section class="content__left">
                <ul class="menu">
                    ...
                    <li class="menu__list">
                        ...
                        <a class="menu__button" href="../profile/{{ $id }}">Мой профиль</a>
                    </li>
                    <li class="menu__list">
