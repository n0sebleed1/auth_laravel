...
<body>
    ...
    <header>
        ...
        <div class="header__user-data">
            <img src="<?php echo e(asset('img/default_avatar.png')); ?>" width="32" height="32">
            ...
            <section class="content__left">
                <ul class="menu">
                    ...
                    <li class="menu__list">
                        ...
                        <a class="menu__button" href="../profile">Мой профиль</a>
                    </li>
                    <li class="menu__list">
                        <svg class="menu__svg" version="1.0" xmlns="http://www.w3.org/2000/svg" width="25.000000px" height="25.000000px" viewBox="0 0 64.000000 64.000000" preserveAspectRatio="xMidYMid meet">
                            <g class="menu__icon" transform="translate(0.000000,64.000000) scale(0.100000,-0.100000)" fill="#4A4A4A" stroke="none">
                        ...
                        <a class="menu__button" href="../message">Сообщения</a>
                    </li>
                    <li class="menu__list">
                        <svg class="menu__svg" version="1.0" xmlns="http://www.w3.org/2000/svg" width="25.000000px" height="25.000000px" viewBox="0 0 64.000000 64.000000" preserveAspectRatio="xMidYMid meet">
                            <g class="menu__icon" transform="translate(0.000000,64.000000) scale(0.100000,-0.100000)" fill="#4A4A4A" stroke="none">
...
</html><?php /**PATH /var/www/u2497761/data/www/allmyfriends.ru/resources/views/layout/app.blade.php ENDPATH**/ ?>