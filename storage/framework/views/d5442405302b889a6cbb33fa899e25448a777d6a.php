...
<?php $__env->startSection('content'); ?>
    <div class="post__list">
        ...
        <div class="post__filter">
            <a class="post__filter-link" href="#">Разработка ПО</a>
            <a class="post__filter-link" href="#">Веб-разработка</a>
            <a class="post__filter-link" href="#">UI/UX</a>
            <a class="post__filter-link" href="#">Кибер-безопасность</a>
            <a class="post__filter-link" href="#">Аналитика</a>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/u2497761/data/www/allmyfriends.ru/resources/views/news.blade.php ENDPATH**/ ?>