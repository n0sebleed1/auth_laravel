...
<?php $__env->startSection('content'); ?>
    ...
    <form class="article" action="<?php echo e(route('create')); ?>" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <textarea name="text_2" class="article__input article__textarea hiden js__attach-text-input" type="text" placeholder="Текст статьи..."></textarea>
        ...
        <textarea name="text_3" class="article__input article__textarea hiden js__attach-text-input" type="text" placeholder="Текст статьи..."></textarea>
        ...
        <textarea name="text_4" class="article__input article__textarea hiden js__attach-text-input" type="text" placeholder="Текст статьи..."></textarea>
        ...
        <textarea name="text_5" class="article__input article__textarea hiden js__attach-text-input" type="text" placeholder="Текст статьи..."></textarea>
        ...
        <textarea name="text_6" class="article__input article__textarea hiden js__attach-text-input" type="text" placeholder="Текст статьи..."></textarea>
