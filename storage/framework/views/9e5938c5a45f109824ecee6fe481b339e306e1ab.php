...
<?php $__env->startSection('content'); ?>
    ...
    <form class="article" action="<?php echo e(route('create')); ?>" method="post" enctype="multipart/form-data">
        ...
        <select class="article__input" name="tag" placeholder="Название статьи...">
            <option value="HTML">Веб-разработка</option>
            <option value="HTML">Разработка ПО</option>
            <option value="CSS">UI/UX</option>
            <option value="PHP">Кибер-безопасность</option>
            <option value="JavaScript">Аналитика</option>
        </select>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/u2497761/data/www/allmyfriends.ru/resources/views/create.blade.php ENDPATH**/ ?>